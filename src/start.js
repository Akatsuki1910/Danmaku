...
var arrow = ["↑", "←", "→", "↓"];
button[0] = new PIXI.Text(level[0], {
  fontFamily: 'Arial',
  fontSize: '50px',
  fill: 0xffffff
});
...
button[1] = new PIXI.Text(level[1], {
  fontFamily: 'Arial',
  fontSize: '40px',
  fill: 0xffffff
});
...
button[2] = new PIXI.Text(level[2], {
  fontFamily: 'Arial',
  fontSize: '40px',
  fill: 0xffffff
});
...
button[3] = new PIXI.Text(level[3], {
  fontFamily: 'Arial',
  fontSize: '40px',
  fill: 0xffffff
});
...
var selectarrow;
selectarrow = new PIXI.Text(arrow[0], {
  fontFamily: 'Arial',
  fontSize: '40px',
  fill: 0xffffff
});
...
function levelselectmode(lev, selev) {
  ...
  button[selev] = new PIXI.Text(level[selev], {
    fontFamily: 'Arial',
    fontSize: '40px',
    fill: 0xffffff
  });
  ...
  button[lev].destroy();
  button[lev] = new PIXI.Text(level[lev], {
    fontFamily: 'Arial',
    fontSize: '50px',
    fill: 0xffffff
  });
  ...
  selectarrow.destroy();
  selectarrow = new PIXI.Text(arrow[lev], {
    fontFamily: 'Arial',
    fontSize: '50px',
    fill: 0xffffff
  });
